package replicatorg.app.ui.modelinggl.tools;
...
//	double previousScale = 1;
	...
	public void mousePressed(MouseEvent e) {
		...
		// last update)
		scaleDragChange = parent.getModel().getBuildModel().getTransform().getScale();
	...
	public void mouseDragged(MouseEvent e) {
		...
		case SCALE_OBJECT:
			...
			double currentScale = parent.getModel().getBuildModel().getTransform().getScale();
